...
//_serverInfoString = format ["<t color='#A0FFFF'>SNAFU #%1 %2 Wasteland</t>", call A3W_extDB_ServerID, worldName];
_serverInfoString = format ["<t color='#A0FFFF'>SNAFU #%1 %2 Wasteland</t>", 1, worldName];
