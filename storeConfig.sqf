...
[
	...
	["IEDLandBig_F", "IEDLandBig_Remote_Mag", 600],
	["IEDLandSmall_F", "IEDLandSmall_Remote_Mag", 500],
	["IEDUrbanBig_F", "IEDUrbanBig_Remote_Mag", 600],
	["IEDUrbanSmall_F", "IEDUrbanSmall_Remote_Mag", 500],
...
[
	...
	["TWS", "optic_tws", 18000, "item"],
	["TWS MG", "optic_tws_mg", 18000, "item"],
...
[
	...
	["Designator Batteries", "Laserbatteries", 50, "mag"],
	["GPS", "ItemGPS", 200, "gps"],
...
[
	...
	//["Base Locker", "Land_Portable_generator_F", 25000, "object"],  //Cael817, Used for base operations <-- Not Destroyable
	["Base Locker", "Land_Device_assembled_F", 25000, "object"],  //Cael817, Used for base operations <-- Destroyable
	...
	["Military Cargo HQ", "Land_Cargo_HQ_V1_F", 8000, "object"],  //Cael817, Added object
	["Concrete Ramp", "Land_RampConcrete_F", 350, "object"],
	["Concrete Ramp (High)", "Land_RampConcreteHigh_F", 500, "object"],
	["Scaffolding", "Land_Scaffolding_F", 250, "object"],
	["ATM machine", "Land_Atm_01_F", 100000, "object"], //Cael817,
	["Food sacks", "Land_Sacks_goods_F", 2500, "object"], //Cael817, Well you want food dont you
	["Water Barrel", "Land_BarrelWater_F", 2500, "object"], //Cael817, Well you want water dont you
	["Fuel Barrel", "Land_MetalBarrel_F", 2500, "object"] //Cael817, Well.... fuel, good to have
];
...
[
	...
	["Offroad Repair Camo", "B_G_Offroad_01_repair_F", 1750, "vehicle"], //Cael817, Added vehicle
	...
	//["UGV Saif RCWS (CSAT)", "O_UGV_01_rcws_F", 60000, "vehicle"]
];
...
[
	...
	["M5 Sandstorm MLRS Rocket Artillery", "B_MBT_01_mlrs_F", 55000, "vehicle"], //Cael817, artillery is fun right?
	["M4 Scorcher Artillery", "B_MBT_01_arty_F", 55000, "vehicle"], //Cael817, artillery is fun right?
	["2S9 Sochor Artillery", "O_MBT_02_arty_F", 55000, "vehicle"] //Cael817, artillery is fun right?
];
...
[
	...
	["MQ4A Greyhawk Bomber UAV", "B_UAV_02_CAS_F", 80000, "vehicle"], // Bomber UAVs are a lot harder to use, hence why they are cheaper than ATGMs
	["K40 Ababil-3 ATGM UAV (CSAT)", "O_UAV_02_F", 100000, "vehicle"],
	["K40 Ababil-3 Bomber UAV (CSAT)", "O_UAV_02_CAS_F", 80000, "vehicle"],
	["K40 Ababil-3 ATGM UAV (AAF)", "I_UAV_02_F", 100000, "vehicle"],
	["K40 Ababil-3 Bomber UAV (AAF)", "I_UAV_02_CAS_F", 80000, "vehicle"]
];
