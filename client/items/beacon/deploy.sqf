...
_MaxSpawnBeacons = switch (_gearLevel) do
	{
		case 1: {_MaxSpawnBeacons = _MaxSpawnBeacons + 1};
		case 2: {_MaxSpawnBeacons = _MaxSpawnBeacons + 2};
		case 3: {_MaxSpawnBeacons = _MaxSpawnBeacons + 3};
		case 4: {_MaxSpawnBeacons = _MaxSpawnBeacons + 3};
		case 5: {_MaxSpawnBeacons = _MaxSpawnBeacons + 3};
		case 6: {_MaxSpawnBeacons = _MaxSpawnBeacons + 3};
		case 7: {_MaxSpawnBeacons = _MaxSpawnBeacons + 3};
		case 8: {_MaxSpawnBeacons = _MaxSpawnBeacons + 3};
		case 9: {_MaxSpawnBeacons = _MaxSpawnBeacons + 3};
		case 10: {_MaxSpawnBeacons = _MaxSpawnBeacons + 3};
		default {_MaxSpawnBeacons};
	};
