...
//Cael817, SNAFU, This is for the reward for playing from GoT
...
//Cael817, handler for UAV and Static Designator assembly, from micovery
player addEventHandler ["WeaponAssembled", {
	...
	if (!(_vehicle isKindOf "UAV_01_base_F" || _vehicle isKindOf "B_Static_Designator_01_F" || _vehicle isKindOf "O_Static_Designator_02_F")) exitWith {};
	...
	_vehicle setVariable ["ownerName", name _player, true];
	_vehicle setVariable ["R3F_LOG_disabled", false, true];
	pvar_manualVehicleSave = netId _vehicle;
...
[] spawn
{
	...
	waitUntil
	{
		...
		if (cameraView == "GROUP") then
		{
 		...
 		uiSleep 0.25; //Cael817, Not in vanilla
		false
	};
};
