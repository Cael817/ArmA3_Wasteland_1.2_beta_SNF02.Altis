...
//Cael817, Not in vanilla
fn_rewardLoyalty = "client\functions\fn_rewardLoyalty.sqf" call mf_compile; //Cael817, For player reward, from GoT
deleteBeacon = "client\items\beacon\deleteBeacon.sqf" call mf_compile; //Cael817, For delete beacon function from LouD and Apoc
