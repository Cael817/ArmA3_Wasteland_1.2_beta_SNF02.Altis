...
if (getNumber (configFile >> "CfgVehicles" >> _class >> "isUav") < 1) then
{
	...
	_vehicle removeMagazinesTurret ["6Rnd_155mm_Mo_AT_mine", [0]]; //Cael817, Remove AT mine ammo.
	_vehicle removeMagazinesTurret ["6Rnd_155mm_Mo_mine", [0]]; //Cael817, Remove AP mine ammo.
};
...
if ({_class isKindOf _x} count ["Air", "LandVehicle", "Ship"] > 0) then //Cael817, Change UGV_01_base_F to LandVehicle and addep ship
{
...
switch (true) do
{
	...
	//Cael817, remove DAGR missiles from Blackfoot and Orca variant and add DAR instead
	/*
	case ({_class isKindOf _x} count ["B_Heli_Attack_01_F", "O_Heli_Light_02_F"] > 0):
	{
		...
		case ({_class isKindOf _x} count ["O_Heli_Attack_02_F", "O_Heli_Attack_02_black_F"] > 0):
	{
		_vehicle removeWeaponGlobal "missiles_SCALPEL";
		//_vehicle addWeaponGlobal "missiles_ASRAAM";
		//_vehicle addMagazineGlobal "4Rnd_AAA_missiles";
		//_vehicle addMagazineGlobal "4Rnd_AAA_missiles";
	};
	//Cael817, End
	*/
