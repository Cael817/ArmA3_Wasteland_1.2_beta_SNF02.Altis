...
_plane setPosATL [_pos select 0, _pos select 1, ((getPosATL _plane) select 2) + 0.2]; //Cael817, changed "select 2) + 0.1" to "select 2) + 0.2"
_plane setVelocity [0,0,0.01];
_plane setFuel (0.4 + random 0.2);
_plane setVariable ["R3F_LOG_disabled", false, true]; //Cael817, So R3F_LOg 3.x works
