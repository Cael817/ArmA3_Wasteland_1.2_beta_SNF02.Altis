...
//{
	...
	_currHeli setPosATL [_finalPos select 0, _finalPos select 1, (_finalPos select 2) + 0.2]; //Cael817, changed "select 2) + 0.1" to "select 2) + 0.2"
	...
	_currHeli setVariable ["R3F_LOG_disabled", false, true]; //Cael817, So R3F_LOg 3.x works
