...
_boat setPosASL [_pos select 0, _pos select 1, 0.2]; //Cael817, changed "select 1, 0" to "select 1, 0.2"
...
_boat setVariable ["R3F_LOG_disabled", false, true]; //Cael817, So R3F_LOg 3.x works
