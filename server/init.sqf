...
if (isServer) then
{
	...
	addMissionEventHandler ["HandleDisconnect",
	{
		...
		deleteMarker "bountyMarker"; //Cael817, Delete bountyMarker when disconnecting
...
if (isServer) then
{
	...
	[
		...
		"A3W_objectLifetime", //Cael817, Well, i might need it
		"A3W_startingBounty", //Cael817, Bounty stuff
		"A3W_maxSpawnBeacons", //Cael817, Spawn Beacon max amount
		"A3W_startingMoney",
...
call compile preprocessFileLineNumbers "mapconfig\setupTownMarkers.sqf"; //Cael817, moved town markers from mission.sqm
call compile preprocessFileLineNumbers "mapconfig\setupStoreOwners.sqf"; //Cael817, moved stores and markers from mission.sqm
call compile preprocessFileLineNumbers "mapconfig\setupMissionMarkers.sqf"; //Cael817, moved mission markers from mission.sqm
call compile preprocessFileLineNumbers "mapconfig\setupVehicleMarkers.sqf"; //Cael817, moved vehicle spawn markers from mission.sqm
call compile preprocessFileLineNumbers "mapconfig\SetupTerritoryMarkers.sqf"; //Cael817, moved territory markers from mission.sqm
