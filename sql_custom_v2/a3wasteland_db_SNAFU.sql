...
-- 01/17/15 09:05:20
-- Model: A3Wasteland SNAFU DB    Version: 1.0
...
CREATE TABLE IF NOT EXISTS `PlayerInfo` (
  ...
  `GearLevel` FLOAT NOT NULL DEFAULT 0,
  `BattlEyeGUID` VARCHAR(32) NULL,
  PRIMARY KEY (`UID`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ServerVehicles` (
  ...
  `LockState` FLOAT NOT NULL DEFAULT 0,
...
START TRANSACTION;
USE `a3wasteland`;
INSERT INTO `DBInfo` (`Name`, `Value`) VALUES ('Version', '1.0');
